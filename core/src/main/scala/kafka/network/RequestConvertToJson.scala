...
object RequestConvertToJson {
  def request(request: AbstractRequest): JsonNode = {
    request match {
      ...
      case req: ConsumerGroupPrepareAssignmentRequest => ConsumerGroupPrepareAssignmentRequestDataJsonConverter.write(req.data, request.version)
  ...
  def response(response: AbstractResponse, version: Short): JsonNode = {
    response match {
      ...
      case req: ConsumerGroupPrepareAssignmentResponse => ConsumerGroupPrepareAssignmentResponseDataJsonConverter.write(req.data, version)
